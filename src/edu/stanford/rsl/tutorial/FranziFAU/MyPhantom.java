...
//		result2.show();
		...
		Grid2D result = reconstruct.openCLBackprojection(sinogram,32, detectorSpacingParallel, numberOfPixelParallel, numberProjectionsParallel, (float)scanAngleParallel, bild.getSpacing(), bild.getOrigin());
		result.show();
	}	
